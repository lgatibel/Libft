...
#    Updated: 2016/10/07 12:36:34 by lgatibel         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_power.c ft_square_root.c ft_absolute.c ft_strndupchr.c ft_atod.c ft_atoi_base.c ft_ishexa.c ft_is_space.c ft_str_is_double.c ft_str_is_hexa.c ft_lltoa_base.c ft_strtoupper.c ft_reverse_tab.c ft_ulltoa_base.c error.c

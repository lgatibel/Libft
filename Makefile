...
#    Updated: 2016/10/03 14:45:19 by lgatibel         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_power.c ft_square_root.c ft_absolute.c ft_strndupchr.c ft_atod.c ft_atoi_base.c ft_ishexa.c ft_is_space.c ft_str_is_double.c ft_str_is_hexa.c ft_itoa_base.c
